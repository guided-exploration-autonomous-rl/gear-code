...
def draw_start_goal(ax, start, goal):
    ax.scatter([start[0]],[start[1]], c='r', s=40)
    ax.scatter([goal[0]],[goal[1]], c='g', s=40)
...
class RoomGenerator:
    ...
    def add_goal(self, position):
        self._worldbody.site(name="goal", pos=[*position, 0], size="0.1", rgba=[0,0.9,0.1,1])
...
class PMRoomGenerator(RoomGenerator):
    ...
    def shell_config(self, start_pos=(0,0), size=1):
        ...
        default.joint(damping=1, limited='false')
        default.geom(friction=".5 .1 .1", density="1000", margin="0.002", condim="1", contype="2", conaffinity="1")
        default.texture(builtin="gradient",height="100",rgb1="1 1 1",rgb2="0 0 0",type="skybox",width="100")
        default.texture(builtin="flat",height="1278",mark="cross",markrgb="1 1 1",name="texgeom",random="0.01",rgb1="0.8 0.6 0.4",rgb2="0.8 0.6 0.4",type="cube",width="127")
        default.texture(builtin="checker",height="100",name="texplane",rgb1="1 1 1",rgb2="1 1 1",type="2d",width="100")
        default.material(name="MatPlane",reflectance="0.5",shininess="0",specular="1",texrepeat="60 60",texture="texplane")
        default.material(name="geom",texture="texgeom",texuniform="true")
        ...
        particle.site(name='particle_site', pos=[0,0,0],rgba='0 1.0 1.0 1', size=0.1)
...
class ComplexMaze(Room, Serializable):
    def __init__(self, base='pm', length=1.2, width=1.2, start=None, target=None):
        Serializable.quick_init(self, locals())
